...
const { rules: baseBestPracticesRules } = require('eslint-config-oceanai/rules/best-practices');
const { rules: baseErrorsRules } = require('eslint-config-oceanai/rules/errors');
const { rules: baseES6Rules } = require('eslint-config-oceanai/rules/es6');
const { rules: baseImportsRules } = require('eslint-config-oceanai/rules/imports');
const { rules: baseStyleRules } = require('eslint-config-oceanai/rules/style');
const { rules: baseVariablesRules } = require('eslint-config-oceanai/rules/variables');
